...
def count(founded_classes, im0):
    ...
    for i, (k, v) in enumerate(founded_classes.items()):
        ...
        cv2.line(im0, (int(align_right), int(align_bottom - 10)), (int(align_right + 210), int(align_bottom - 10)),
                 (0, 255, 0), 40)
        cv2.putText(im0, str(a), (int(align_right), int(align_bottom)), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 255, 255), 2,
                    cv2.LINE_AA)
